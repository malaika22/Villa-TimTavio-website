    ...
    panels: [
      {
        ...
        rooms: [
          ...
          { index: '05', name: 'Shared Suite', guests: '3 Guests', beds: [['twin'], ['twin', 'twin']], bedLabel: '3 Twin beds (Bunk room)' },
          { index: '06', name: 'Shared Suite', guests: '3 Guests', beds: [['twin'], ['double']], bedLabel: 'Queen bed + 1 Twin bed (Bunk room)' },
        ],
      },
    ],
  },
